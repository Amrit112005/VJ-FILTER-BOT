...
reqst_channel = environ.get('REQST_CHANNEL', '1915001261')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '2078072102')).split()]  # For Multiple Id Use One Space Between Each.
